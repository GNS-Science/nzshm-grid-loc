...
from nzshm_grid_loc.grids import Grid
from nzshm_grid_loc.io import load_grid, write_grid, write_zip, load_zip, load_wkt_csv, write_grid_to_file, \
    data_to_base64_zip, latlon_from_base64_zip
...
def test_read_write_zip(tmp_path):
    ...
    write_zip(str(tmp_file), content)
...
def test_base64zip():
    ...
    base64_zip = data_to_base64_zip(out_file.getvalue())
